...
class QCDdiphoton : public edm::EDAnalyzer {
public:
  explicit QCDdiphoton(const edm::ParameterSet&);
  ~QCDdiphoton();
...
QCDdiphoton::QCDdiphoton(const edm::ParameterSet& iConfig):
...
QCDdiphoton::~QCDdiphoton()
{
}

void
QCDdiphoton::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
QCDdiphoton::beginJob(const edm::EventSetup& es, const edm::ParameterSet& ps)
{
...
void
QCDdiphoton::fillDescriptions(edm::ConfigurationDescriptions& descriptions) 
{
